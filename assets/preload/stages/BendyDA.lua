...
function onCreate()
  if songName == 'build-our-freaky-machine' then
    ...
    makeLuaSprite('bendyBGBlackWhite','bendy/images/BonusSongs/dabg - Black & White',-350,50)
    scaleObject('bendyBGBlackWhite',3.8, 3.8);
    setProperty('bendyBGBlackWhite.visible',false)

    makeAnimatedLuaSprite('bendyVideoBlackWhite','bendy/images/BonusSongs/reel',-100,-100)
    ...
    makeLuaSprite('Curtain1BlackWhite','bendy/images/BonusSongs/Curtain1 - Black & White',-300,-170)
    scaleObject('Curtain1BlackWhite',1.5,1.5)
    setProperty('Curtain1BlackWhite.visible',false)

    makeLuaSprite('Curtain2BlackWhite','bendy/images/BonusSongs/Curtain2 - Black & White',600,-170)
   ...
   if not lowQuality then
    ...
    makeLuaSprite('BendyVignette', 'bendy/images/gay/C_07',0,0);
  ...
  makeAnimatedLuaSprite('bendyVideo','bendy/images/reel',-100,-100)
...
function onCreatePost()
  makeLuaSprite('prechaceNote','bendy/images/BonusSongs/NOTE_assets',0,0)
